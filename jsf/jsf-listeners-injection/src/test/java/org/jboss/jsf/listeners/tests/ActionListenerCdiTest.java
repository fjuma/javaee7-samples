...
@RunAsClient
public class ActionListenerCdiTest {
	...
	public void testActionListener() throws Exception {
		assertTrue("Injection to action listener didn't happen!", clickOnAction("form:link").contains("Number of injections 1"));
		assertTrue("Interceptor for action listener wasn't executed!", clickOnAction("form:link").contains("Number of interceptors 1"));
	}
	
	@Test
	public void testActionListener2() throws Exception {
		assertTrue("Injection to action listener didn't happen!", clickOnAction("form:link2").contains("Number of injections 1"));
		assertTrue("Interceptor for action listener wasn't executed!", clickOnAction("form:link2").contains("Number of interceptors 1"));
	}
